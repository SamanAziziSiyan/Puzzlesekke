		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="col-sm-12 col-md-6 col-lg-6">
				<div class="panel panel-info wrapper-margin-top">
					<div class="panel-heading" id="panel-login-heading"><?php echo $form_titles['login']; ?></div>
					<div class="panel-body">
						<form class="form-horizontal" id="login-register-form">
							...
							<div class="form-group input-container">
								<div class="col-sm-10 col-sm-offset-1">
									<input type="password" id="password" data-toggle="password" class="form-control input-lg" placeholder="کلمه خود را وارد نمایید...">
			...
			<div class="col-sm-12 col-md-6 col-lg-6">
				<div class="panel panel-info wrapper-margin-top">
					<div class="panel-heading" id="panel-register-heading"><?php echo $form_titles['register']; ?></div>
					<div class="panel-body">
						<form class="form-horizontal" id="login-register-form">
							<div class="form-group input-container">
								<div class="col-sm-10 col-sm-offset-1">
									<input type="text" class="form-control input-lg" placeholder="نام خود را وارد نمایید...">
							...
							<div class="form-group input-container">
								<div class="col-sm-10 col-sm-offset-1">
									<input type="text" class="form-control input-lg" placeholder="نام خانوادگی خود را وارد نمایید...">
							...
							<div class="form-group input-container">
								<div class="col-sm-10 col-sm-offset-1">
									<input type="email" class="form-control input-lg" placeholder="تکرار ایمیل...">
									<i class="material-icons input-icon">email</i>
								</div>
							...
							<div class="form-group input-container">
								<div class="col-sm-10 col-sm-offset-1">
									<input type="password" class="form-control input-lg" id="password" data-toggle="password" placeholder="کلمه عبور  خود را وارد نمایید...">
									<i class="material-icons input-icon">lock_open</i>
								</div>
							...
							<div class="form-group input-container">
								<div class="col-sm-10 col-sm-offset-1">
									<input type="password" class="form-control input-lg" id="password" data-toggle="password" placeholder="تکرار کلمه عبور...">
									<i class="material-icons input-icon">lock_open</i>
								</div>
